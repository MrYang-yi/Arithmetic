...
public class TimeWheel {
     ...
     * 槽
     */
    private TimerTaskList2[] buckets;
     ...
     */
    private DelayQueue<TimerTaskList2> delayQueue;

    public TimeWheel(long tickMs, int wheelSize, long currentTime, DelayQueue<TimerTaskList2> delayQueue) {
        this.currentTime = currentTime;
        this.tickMs = tickMs;
        this.wheelSize = wheelSize;
        this.interval = tickMs * wheelSize;
        this.buckets = new TimerTaskList2[wheelSize];
        this.currentTime = currentTime - (currentTime % tickMs);
        this.delayQueue = delayQueue;
        for (int i = 0; i < wheelSize; i++) {
            buckets[i] = new TimerTaskList2();
        }
    }

    public boolean add(TimerTaskEntry1 entry) {
        ...
        if (expiration < tickMs + currentTime) {
            ...
            TimerTaskList2 bucket = buckets[index];
